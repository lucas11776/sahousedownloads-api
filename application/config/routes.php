...
$route['password/recover']        = 'password/recover';         // DONE ( Implement send email logic )
$route['password/reset']          = 'password/reset';           // DONE
$route['password/token/(:any)']   = 'password/token/$1';        // DONE
